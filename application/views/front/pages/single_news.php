<section class="info py-5" style="margin-bottom: 3rem">
	<div class="container">
		<div class="row  mb-4">
			
			<div class="col-12 mb-3 text-center">
				<img class="img-fluid separator lazy" data-src="<?= assets() ?>img/separator.svg" alt="separator">
				<h1 class="news-title mb-5"><?= $info->title ?></h1>
			</div>
			<div class="col-12 text-center mb-5">
				<img data-src="<?= file_url(). $info->photo ?>" alt="<?= $info->alt ?>" class="img-fluid lazy">
			</div>
			<div class="col-12">
				<?= $info->description ?>
			</div>
