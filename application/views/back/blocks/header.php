<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="<?php echo base_url(); ?>panel/header_button/form/update/1" class="br-menu-link
        <?php if($this->uri->segment(2) == 'header_button' || $this->uri->segment(4) == 'header_button'){echo 'active';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-link tx-20"></i>
            <span class="menu-item-label">Przycisk w menu</span>
          </div>
        </a>

        <?php $links = ['Slider' => 'slider']; ?>
        ...
        <?php $links = ['Aktualności' => 'news', 'Przycisk' => 'news_button/form/update/1', 'Opisy' => 'news_descriptions/form/update/1']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2). '/form/update/1', $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <?php if(in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2). '/form/update/1', $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            ...
            <span class="menu-item-label">Baza wiedzy</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Lista' => 'electromobility', 'Opisy' => 'electromobility_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2). '/form/update/1', $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-charging-station tx-20"></i>
            <span class="menu-item-label">Elektromobilność</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Lista' => 'models', 'Opisy' => 'models_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2). '/form/update/1', $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-car tx-20"></i>
            <span class="menu-item-label">Modele</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Newsletter' => 'newsletter', 'Newsletter opisy' => 'newsletter_descriptions/form/update/1', 'Subskrybenci' => 'subscribers']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links) || in_array($this->uri->segment(2). '/form/update/1', $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-paper-plane tx-20"></i>
    ...
    <div class="br-sideright">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="settings" role="tabpanel">
          ...
          <div class="pd-y-20 pd-x-25 tx-white">
            <h6 class="tx-13 tx-normal">Zgoda na newsletter:</h6>
            <p class="op-5 tx-13">Klauzula RODO</p>
            <div class="pos-relative">
